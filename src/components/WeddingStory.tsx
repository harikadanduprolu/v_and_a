...
<h3 className="font-serif text-2xl text-gray-800 mb-4 text-center">Our Wedding</h3>
<div className="aspect-[16/9] rounded-lg overflow-hidden bg-rose-100 mb-6">
  <div className="w-full h-full flex items-center justify-center">
    <p className="font-serif italic text-rose-500">Video will be displayed here</p>
  </div>
</div>
